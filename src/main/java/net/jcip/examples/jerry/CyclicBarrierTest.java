 ...
 */
/**
 * Component 0 generates: 52
Component 1 generates: 66
Component 0 sleep
Component 1 sleep
testCyclicBarrier run
Component 1 awaked
Component 0 awaked
Component 1 result: 184
Component 0 result: 118
 * @author jerry
 *
 */
public class CyclicBarrierTest {
	...
	public static void testCyclicBarrier() {
		...
		CyclicBarrier barrier = new CyclicBarrier(2, new Runnable() {
			// 在所有线程都到达Barrier时执行
			public void run() {
				System.out.println("testCyclicBarrier run start...");
				array[2] = array[0] + array[1];
				System.out.println("testCyclicBarrier run:" + array[2]);
			}
		});
